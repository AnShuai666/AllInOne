...
QT_MOC_LITERAL(1, 10, 15), // "emitDeleteImage"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 11) // "changeImage"

    },
    "ImageShow\0emitDeleteImage\0\0changeImage"
};
...
void ImageShow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->emitDeleteImage(); break;
        ...
        {
            typedef void (ImageShow::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageShow::emitDeleteImage)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject ImageShow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ImageShow.data,
      qt_meta_data_ImageShow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void ImageShow::emitDeleteImage()
{
