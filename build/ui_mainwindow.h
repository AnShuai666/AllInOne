...
public:
    ...
    QAction *videoeditAction;
    QAction *pointCloudEditAction;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        videoeditAction = new QAction(MainWindow);
        videoeditAction->setObjectName(QStringLiteral("videoeditAction"));
        pointCloudEditAction = new QAction(MainWindow);
        pointCloudEditAction->setObjectName(QStringLiteral("pointCloudEditAction"));
        ...
        editModeMenu->addAction(videoeditAction);
        editModeMenu->addAction(pointCloudEditAction);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        videoeditAction->setText(QApplication::translate("MainWindow", "\350\247\206\351\242\221\347\274\226\350\276\221", 0));
        pointCloudEditAction->setText(QApplication::translate("MainWindow", "\347\202\271\344\272\221\347\274\226\350\276\221", 0));
